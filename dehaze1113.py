...
class Dense_rain_cvprw3(nn.Module):
    ...
    def forward(self, x):
        ...
        #original
        #residual = self.tanh(self.refine3(dehaze))
        ## dehaze=x - residual #origianlly commented
        residual = F.sigmoid(self.refine3(dehaze))
...
class single(nn.Module):
	...
	#by Manu
        residual = self.tanh(self.refine4(x9)) #original
        #residual = self.sigmoid(self.refine4(x9)) #by Manu
